...
[![GitHub Downloads](https://img.shields.io/github/downloads/pkgforge-dev/Amarok-AppImage/total?logo=github&label=GitHub%20Downloads)](https://github.com/pkgforge-dev/Amarok-AppImage/releases/latest)
[![CI Build Status](https://github.com/pkgforge-dev/Amarok-AppImage/actions/workflows/appimage.yml/badge.svg)](https://github.com/pkgforge-dev/Amarok-AppImage/releases/latest)
...
| :---: | :---: |
| [Click here](https://github.com/pkgforge-dev/Amarok-AppImage/releases/latest) | [Click here](https://invent.kde.org/multimedia/amarok) |
